                         ...
                         char* server)
{
    ...
    if(send(sr->sockfd, buf, (int)buf_len, 0) != (int)buf_len)
    {
                         ...
                         const char* iface /* borrowed */)
{
    ...
    if( write(sr->sockfd, sr_pkt, total_len) < (int)total_len )
    {
